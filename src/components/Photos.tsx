  ...
  return (
    <div className="p-5">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-black tracking-tighter uppercase" style={{ color: profile.borderA }}>Media Gallery</h2>
          <p className="text-sm font-medium opacity-50" style={{ color: profile.text }}>Visual insights from the community</p>
        </div>
        <div className="flex space-x-2">
          ...
          <button 
            ...
            style={{ background: `${profile.borderA}11`, color: profile.borderA, borderColor: `${profile.borderA}22` }}
          >
      ...
      {allMedia.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 rounded-3xl border border-dashed" style={{ background: `${profile.borderA}05`, borderColor: `${profile.borderA}22` }}>
          <ImageIcon size={48} className="mb-4 opacity-20" style={{ color: profile.borderA }} />
          <p className="font-medium opacity-50" style={{ color: profile.text }}>No media shared yet</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-4">
                <div className="flex items-center justify-between text-white">
                  ...
                  <Maximize2 size={16} style={{ color: profile.borderA }} />
                </div>
